...
class HostControl extends L.Control {
    ...
    onAdd(map) {
        ...
        let image = new Image();
        image.src = 'modules/imap/imap/images/filter.png';
    ...
    updateHost(host) {
        ...
        if (this.hostElemenentList.hasOwnProperty(host.hostid)) {
            ...
            L.DomEvent.on(hostElement, 'click', () => this.onHostClick(host), this);
        ...
        if (!host.hasLocation()) {
            ...
            setHostLocation.setAttribute('src', 'modules/imap/imap/images/target.png');
