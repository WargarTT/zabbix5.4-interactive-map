...
class LastTriggers extends L.Control {
    ...
    addTrigger(trigger) {
        ...
        let linkMenuContainer = L.DomUtil.create('div', 'trigger-host', container);
        ...
        L.DomUtil.create('div', 'trigger-description', container).innerText = trigger.description;
        ...
        let lastChange = L.DomUtil.create('div', 'lastchange', container);
        lastChange.setAttribute('lastchange', trigger.lastchange);
        lastChange.innerText = new Date(trigger.lastchange * 1000).toLocaleString();
