...
class MarkerPopupActions {
    ...
    static changeLocation(host) {
        return this.create({
            ...
            image: 'modules/imap/imap/images/target.png',
            onAction: () => {
    ...
    static removeHostLocation(host) {
        return this.create({
            ...
            image: 'modules/imap/imap/images/target-del.png',
            onAction: () => {
    ...
    static hostDebugInfo(host) {
        return this.create({
            ...
            image: 'modules/imap/imap/images/debug.png',
            onAction: () => {
    ...
    static getHardware(host) {
        return this.create({
            ...
            image: 'modules/imap/imap/images/hardware.png',
            onAction: () => {
    ...
    static addLink(host) {
        return this.create({
            ...
            image: 'modules/imap/imap/images/link.png',
            onAction: () => {
