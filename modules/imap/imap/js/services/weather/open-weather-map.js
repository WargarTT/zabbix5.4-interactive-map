...
class OpenWeatherMapService {
    ...
    create(latLng) {
        if (!this.popup) {
            ...
            this.content.innerHTML = '<!--suppress CheckImageSize --><img width="50px" src="modules/imap/imap/images/image-loading.gif" alt="" />';
    ...
    setResult(data) {
        ...
        ocontainer.style.backgroundImage = 'url("modules/imap/imap/images/wind_arrow_x1.png")';
        ...
        container.style.backgroundImage = 'url("modules/imap/imap/images/wind_arrow_x1.png")';
